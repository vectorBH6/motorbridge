...
// Product Literature/RS05/RS05User Manual260428.pdf.
pub static RS05_PARAMETER_TABLE: &[ParameterInfo] = &[
    ...
    param!(0x3035, "cs_angle", Float32),
    param!(0x3036, "vel_max", Float32),
    param!(0x3037, "judge", Float32),
    ...
    param!(0x3044, "low_position", Float32),
    param!(0x3045, "theta_mech_1", Float32),
    param!(0x3046, "instep", Float32),
    param!(0x3047, "position", Float32),
    param!(0x3048, "chasu_angle_init", Float32),
    param!(0x3049, "chasu_angle_out", Float32),
    param!(0x304A, "motormechinit", Float32),
    param!(0x304B, "mech_angle_init2", Float32),
    param!(0x304C, "mech_angle_rotat", Int16),
    param!(0x304D, "pos_cnt1", UInt16),
    param!(0x304E, "H", UInt8),
