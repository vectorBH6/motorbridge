...
// Product Literature/RS00/RS00User Manual260428.pdf.
pub static RS00_PARAMETER_TABLE: &[ParameterInfo] = &[
    ...
    param!(0x201F, "vel_max", Float32),
    param!(0x2020, "acc_set", Float32),
    param!(0x2021, "zero_sta", Float32),
    param!(0x2022, "protocol_1", UInt8),
    param!(0x2023, "damper", UInt8),
    param!(0x2024, "add_offset", Float32),
    ...
    param!(0x3031, "zero_fault", Float32),
    param!(0x3032, "chasu_coder_raw", Float32),
    param!(0x3033, "chasu_angle", Float32),
    param!(0x3034, "as_angle", Float32),
    param!(0x3035, "vel_max", Float32),
    param!(0x3036, "judge", UInt8),
    param!(0x3037, "position", Float32),
    param!(0x3038, "chasu_angle_init", Float32),
    param!(0x3039, "chasu_angle_out", Float32),
    param!(0x303A, "motormechinit", Float32),
    param!(0x303B, "mech_angle_init2", Float32),
    param!(0x303C, "mech_angle_rotat", Float32),
    ...
    param!(0x3045, "ElecOffset", Float32),
    param!(0x3046, "mcOverTemp", Int16),
    param!(0x3047, "Kt_Nm/Amp", Float32),
    param!(0x3048, "Tqcali_Type", UInt8),
    param!(0x3049, "low_position", Float32),
    param!(0x304A, "theta_mech_1", Float32),
    param!(0x304B, "instep", Float32),
    param!(0x304C, "adc0ffset_1", Int32),
    param!(0x304D, "adc0ffset_2", Int32),
    param!(0x304E, "pos_cnt1", UInt16),
    param!(0x304F, "H", UInt8),
