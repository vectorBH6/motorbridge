...
// Product Literature/RS01/RS01User Manual260428.pdf.
pub static RS01_PARAMETER_TABLE: &[ParameterInfo] = &[
    ...
    param!(0x302F, "limit_i", Float32),
    param!(0x3030, "mcOverTemp", Int16),
    param!(0x3031, "Kt_Nm/Amp", Float32),
    param!(0x3032, "Tqcali_Type", UInt8),
    param!(0x3033, "fault1", UInt32),
    param!(0x3034, "fault2", UInt32),
    param!(0x3035, "fault3", UInt32),
    param!(0x3036, "fault4", UInt32),
    param!(0x3037, "fault5", UInt32),
    param!(0x3038, "fault6", UInt32),
    param!(0x3039, "fault7", UInt32),
    param!(0x303A, "fault8", UInt32),
    param!(0x303B, "theta_mech_1", Float32),
